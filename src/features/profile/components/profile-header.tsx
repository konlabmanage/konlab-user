...
export function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <div className="flex items-center gap-6 md:flex-row md:items-start">
      ...
      <div className="flex flex-1 flex-col gap-4">
        <div>
          ...
          <p
            className={cn(
              ...
              user?.position ? 'text-foreground' : 'text-muted-foreground',
            )}
          >
        ...
        <div className="flex gap-2 md:flex-row md:gap-3">
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn('text-sm', user?.phone ? 'text-foreground' : 'text-muted-foreground')}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn('text-sm', user?.email ? 'text-foreground' : 'text-muted-foreground')}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                'text-sm',
                user?.department ? 'text-foreground' : 'text-muted-foreground',
              )}
            >
